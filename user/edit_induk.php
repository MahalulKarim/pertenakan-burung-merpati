                              ...
                              <?php
                                  ...
                                  while($data2=mysqli_fetch_array($result2)){
                                      if ($data['id_betina']==$data2['id_burung']) {?>
                                        ...
                                        <option value="<?= $data2['id_burung']?>" selected><?php echo $data2['nama']." [".$data2['ring']."]"?></option>

                                        <?php
                                        # code...
                                      }else{?>
                                        <option value="<?= $data2['id_burung']?>"><?php echo $data2['nama']." [".$data2['ring']."]"?></option>
                                     <?php }
                                    ?>
                              ...
                              <?php
                                  ...
                                  while($data3=mysqli_fetch_array($result3)){
                                    if ($data['id_jantan']==$data3['id_burung'])  {?>
                                        ...
                                        <option value="<?= $data3['id_burung']?>" selected><?php echo $data3['nama']." [".$data3['ring']."]"?></option>

                                        <?php
                                        # code...
                                      }else{?>
                                        <option value="<?= $data3['id_burung']?>"><?php echo $data3['nama']." [".$data3['ring']."]"?></option>
                                     <?php }
                                    ?>
                              <?php
                                  }
