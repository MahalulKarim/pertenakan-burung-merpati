            ...
            <div class="card bg-info" style="">
              ...
              <div class="card-body">
                <h1 class="card-text text-center">
                  <?php 
                    $query="SELECT count(*) as total_burung FROM burung WHERE id_user='$id_user'";
          ...
          <div class="col-lg-3 col-12">
            <div class="card bg-primary" style="">
              ...
              <div class="card-body">
                <h1 class="card-text text-center">
                  <?php 
                    $query1="SELECT count(*) as total_induk FROM induk WHERE id_user='$id_user'";
          ...
          <div class="col-lg-3 col-12">
            <div class="card bg-warning" style="">
              ...
              <div class="card-body">
                <h1 class="card-text text-center">
                  <?php 
                    $query2="SELECT count(*) as total_ternak FROM ternak WHERE id_user='$id_user'";
          ...
          <div class="col-lg-3 col-12">
            <div class="card bg-success" style="">
              ...
              <div class="card-body">
                <h1 class="card-text text-center">
                  <?php 
                    $query3="SELECT count(*) as total_ternak FROM ternak WHERE status='1' AND id_user='$id_user'";
