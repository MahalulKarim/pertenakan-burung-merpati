                        ...
                        <div class="col-lg-3">
                            <form action="#" method="GET">
                                ...
                                <span class="input-group-append">
                                    <a href="data_laporan_pemesanan.php" class="btn btn-success btn-flat"><i class="fas fa-undo"></i></a>
                                  </span>
                              ...
                              <h6>Laporan Penjualan Ternak Dari Tgl <?php echo date('d-m-Y',strtotime($tgl1))?> s/d <?php echo date('d-m-Y',strtotime($tgl2))?></h6>
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        $no=1;
                                         $query="SELECT f.*, t.kode,u.nama as name FROM finance f, ternak t, user u WHERE f.tgl_transaksi BETWEEN '$tgl1' AND '$tgl2' AND u.id_user=f.id_user AND t.id_ternak=f.id_pt" ;
