              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane fade <?= $aktive=='3' ? 'show active' : ''; ?>" id="custom-tabs-one-data-burung" role="tabpanel" aria-labelledby="custom-tabs-one-data-burung-tab">
                     <a href="downloadBurungPdf.php" target="_blank" class="btn btn-info btn-sm"><i class="fas fa-file-pdf"></i> Download PDF</a>
                     <a href="exportBurungExcel.php" target="_blank" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php
                              ...
                              $no=1;
                              $query="SELECT b.*,u.nama as name FROM burung b, user u where u.id_user=b.id_user";
                              $result=mysqli_query($db,$query);
                              while($data=mysqli_fetch_array($result))
                            {
                          ?>
                        ...
                        <div class="col-8 col-sm-9">
                          <div class="tab-content" id="vert-tabs-tabContent">
                            ...
                            <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                              <a href="downloadTernakPdf.php" target="_blank" class="btn btn-info btn-sm"><i class="fas fa-file-pdf"></i> Download PDF</a>
                              <a href="exportTernakExcel.php" target="_blank" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                                         ...
                                         <i class="fas fa-plus-circle"></i>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <p>Nama Burung : </p>
                                                <p><?php echo $data5['nama_burung'] ?></p>
                                                <p>Input By : </p>
