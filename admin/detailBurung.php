      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <?php 
            if (isset($_GET['id'])) {
              $id=$_GET['id'];
               $query="SELECT * FROM burung WHERE id_burung='$id'";
                                ...
                                <table>
                                    <thead>
                                        ...
                                        <tr>
                                            <th>Induk Jantan</th>
                                            <th>:</th>
                                            <th><?php echo $data['induk_jantan']?></th>
                                        </tr>
                                        <tr>
                                            <th>Induk Betina</th>
                                            <th>:</th>
                                            <th><?php echo $data['induk_betina']?></th>
                                        </tr>
                                        <tr>
                                            <th>Keterangan</th>
                                            <th>:</th>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php 
                                $query2="SELECT * FROM galleri_burung WHERE id_burung='$id'";
                            ...
                            <div class="col-3">
                                <div class="card card-hover" >
                                    ...
                                    <div class="card-footer">
                                       ...
                                       <a href="hapusGalleriBurung.php?id=<?php echo $data2['id_galleri']?>" class="btn btn-danger btn-xs" onclick="return(confirm('Yakin Hapus Foto Burung?'))">Hapus</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="simpanFotoBurung.php" method="POST" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_burung" value="<?php echo $data2['id_burung']?>">
          ...
          <div class="col-lg-3 col-12">
            <!-- small box -->
            <a href="detailBurung.php?id=<?php echo $data['id_burung']?>" class="text-dark">
